<template>
  <div class="container">
    ...
    <h5 class="center">A new way to travel in Sheet Rock Hills</h5>
    <br />
    <div class="flex-center">
      <div class="center">
        <div class="six columns">
          <div class="boxcard">
            <h4 class="zero" style="margin-top: 0.6em;">Safe Rail Metro Stations</h4>
            <p>Handy-Manny Corp. introduces a new metro system to travel in, duringthe COVID 19 pandemic. It also gives the added benefit of zero contact at the station.</p>
          </div>
        </div>
        <div class="six columns">
          <div class="boxcard">
            <h4 class="zero" style="margin-top: 0.6em;">Travel Hygeine Kits</h4>
            <p>Handy-Manny Corp. sells cheap Travel Hygeine Kits to the consumers, so that they can take extra precautions while travelling the Metro.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="seven columns text">
        <p>Travel is arguably one of the most integral parts of a person's life, especially for the world renowned Handy Manny and his personified tools. Airplanes have dominated the air and airports were bustling cities, until they became the vehicle of transfer of the COVID- 19 virus. Global and local markets have all but collapsed and governments around the world are in a dire status, trying to strike a balance between keeping their market economies going, averting unemployment and deprivation of the poor while trying to respond to public health essentials.</p>
        
        <p>Another issue would be the fact that currently, people are scared of visiting public places due to the fear of the crowds. Yet, people depend on public transport for their livelihood.</p>
        <p>
          We want to help them get back their means of commute. Therefore Handy-Manny Corp. created
          <b>Safar</b>. An app that will help you travel in the brand new Metro, and at the same time return to the normal life you had to abandon due to this pandemic.
    ...
    <div class="row">
      ...
      <div class="seven columns">
        <h3>Our app</h3>
        <p>You start off using Handy-Manny's Safar app by logging in and linking your Handy-Manny account to the app, which is essential to be allowed to travel in the Metro.</p>
        <p>On the hospitals page, the user can see various hospitals across Sheet Rock Hills, along with the number of vaccines they have. This way the user can decide which hospital they wish to visit.</p>
    ...
    <div class="vidpen">
      <div>
        <iframe
          width="100%"
          src="https://www.youtube.com/watch?v=ZdKAmLO8RA0&feature=youtu.be"
          frameborder="0"
